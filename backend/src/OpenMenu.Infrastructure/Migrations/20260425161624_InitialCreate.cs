        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DecodedUrl = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QRRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QRRequests_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QRRequests_RestaurantId",
                table: "QRRequests",
                column: "RestaurantId");
        }
